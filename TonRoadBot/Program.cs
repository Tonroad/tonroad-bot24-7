...
} вот код при котором идет с одного номера админу а вот назад не получается тк пишу с админа и бот дует это просто клиент и мне же сразу отсылает то что я прислал ему
